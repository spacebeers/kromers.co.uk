        ...
        public function widget( $args, $instance ) {
            ...
            echo $before_title . $title . $after_title; ?>
                <ul class="social-list">
                    <?php if (get_theme_mod( 'kromers_facebook')): ?>
                        <li class="facebook">
                            <a href="<?php echo get_theme_mod( 'kromers_facebook'); ?>" target="_blank">
                                <img src="<?php bloginfo('template_directory'); ?>/assets/facebook.png" />
                            </a>
                        </li>
                    <?php endif; ?>
                    <?php if (get_theme_mod( 'kromers_twitter')): ?>
                        <li class="twitter">
                    ...
                    <?php endif; ?>
                    <?php if (get_theme_mod( 'kromers_linkedin')): ?>
                        <li class="linkedin">
                            <a href="<?php echo get_theme_mod( 'kromers_linkedin'); ?>" target="_blank">
                                <img src="<?php bloginfo('template_directory'); ?>/assets/linkedin.png" />
                            </a>
                        </li>
                    <?php endif; ?>
                </ul>
